...
Real-time buoy detection and localization for an Autonomous Surface Vehicle (ASV) developed in the [**Njord Challenge**](https://www.njordchallenge.com/) student team.
...
- **Buoy_detection.py** An earlier program using color-threshold masks for detection, that didn't use machine learning. It succesfully was able to mask green, red, yellow and black colors from the buoys, but we had problems with the cardinal marks, since the order of the colors is what distinguishes them.
